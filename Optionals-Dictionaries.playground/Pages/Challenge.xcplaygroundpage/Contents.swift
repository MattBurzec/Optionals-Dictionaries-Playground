...
contactName["Kobe"] = "Lebron"
contactName["Patrick"] = "Burzec"
contactName["Matt"] = "Burzec"
...
func findContact(name: String) {
    if let phoneNumber = contactName[name] {
    print("\(name) can be called at \(phoneNumber)")
    }
    else {
        print("\(name) is not in your phonebook")
    }
}

func updateContact(name: String, phoneNumber: String) {
    contactName[name] = phoneNumber
    if contactName[name] == contactName[name] {
        print("\(name) has been updated in your phonebook")
    }
    else if contactName[name] != contactName[name] {
        print("\(name) did not exist. It has been added to your phone book")
    }
}

func deleteContacts(name: String) {
    if contactName[name] == contactName[name] {
...
func allContacts(name: String, phoneNumber: String) {
        print("\(contactName[name]) can be called at \(contactName[phoneNumber])")
}
